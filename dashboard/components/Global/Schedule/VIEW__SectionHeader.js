...
const VIEW__SectionHeader = (props) => {
    ...
    */
    ...
    const [headerDate, setHeaderDate] = useState(FUNC__SetHeaderDate(new Date(), "dayview"));
    /*
    *
    *
    * 
            ...
            case "weekview":
                props.FUNC__Navigate__Weekview(
                    ...
                    props.FUNC__ResetWeekView(
                        ...
                        props.manager_id,
                        props.loggedin_user_role
                    )
                );
                //props.FUNC__FetchData__Weekview();
                break;
            case "monthview":
