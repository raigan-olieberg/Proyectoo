...
import { 
    ...
    GLOBALFUNC__GetAnalyticsForManager__WorkedHours,
    GLOBALFUNC__GetUser,
...
export const getResourcesAnalyticsForManager = async (req, res, next) => {
    let analyticsData = {};
    ...
    try {
        ...
        if(req.body.include_organization_analytics){
            const organizationWorkedHoursDoc = await GLOBALFUNC__GetAnalyticsForManager__WorkedHours(
                req.body.manager_id,
                req.body.current_year,
                req.body.type,
                req.body.month_or_week_value
...
export const getResourcesWorkedHoursForManager = async (req, res, next) => {
    let workedHoursData = {};
